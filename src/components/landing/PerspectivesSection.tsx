...
const PerspectivesSection = () => {
  return (
    <section className="py-24 bg-secondary/30 border-t border-border transition-colors duration-300">
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          {perspectives.map((p, i) => (
            <div key={i} className="p-10 rounded-[32px] bg-card border border-border flex flex-col items-start hover:shadow-xl transition-all duration-300 group">
               <div className="w-12 h-12 rounded-full bg-primary flex items-center justify-center mb-8 shadow-lg shadow-primary/20 transition-transform group-hover:rotate-6">
               ...
               <div className="mt-auto w-full pt-8 border-t border-border">
